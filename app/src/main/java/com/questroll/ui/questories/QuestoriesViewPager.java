...
public class QuestoriesViewPager extends ViewPager {

  public QuestoriesViewPager(Context context) {
    super(context);
    init();
  }
  ...
  public QuestoriesViewPager(Context context, AttributeSet attributeSet) {
